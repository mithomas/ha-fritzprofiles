"""Tests for AVM FRITZ!Box Access Profiles api."""
import asyncio

import aiohttp
from custom_components.https://github.com/mithomas/ha-fritzprofiles.api import (
    HaProfilesApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = HaProfilesApiClient("test", "test", async_get_clientsession(hass))
